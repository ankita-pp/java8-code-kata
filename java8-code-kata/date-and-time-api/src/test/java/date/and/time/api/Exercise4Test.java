...
public class Exercise4Test {
    ...
    public void zonedDateTimeOf() {
        ...
        ZonedDateTime zonedDateTime = ZonedDateTime.of(2015, 07, 10, 2, 14, 25, 000, zoneId);
    ...
    public void zonedDateTimeParse() {
        ...
        String date = "2015-06-18T23:07:25+09:00[Asia/Tokyo]";
    ...
    public void zonedDateTimeFormat() {
        ...
        String strZdt = zdt.format(formatter);
    ...
    public void toPST() {
        ...
        ZonedDateTime zonedDateTime = ldt.atZone(zone.toZoneId());
    ...
    public void sameInstantAs() {
         ...
         */
        TimeZone zone = TimeZone.getTimeZone("America/Los_Angeles");
        ZonedDateTime zonedDateTime = zdt.withZoneSameInstant(zone.toZoneId());
    ...
    public void sameLocalAs() {
         ...
         */
        TimeZone zone = TimeZone.getTimeZone("America/Los_Angeles");
        ZonedDateTime zonedDateTime = zdt.withZoneSameLocal(zone.toZoneId());
