...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void sortByAge() {
         ...
         */
        Stream<Integer> sortedAgeStream = customerList.stream().sorted(Comparator.comparing(Customer::getAge)).map(Customer::getAge);
    ...
    public void descSortByAge() {
         ...
         */
        Stream<Integer> sortedAgeStream = customerList.stream().sorted(Comparator.comparing(Customer::getAge).reversed()).map(Customer::getAge);
        List<Integer> sortedAgeList = sortedAgeStream.collect(Collectors.toList());
