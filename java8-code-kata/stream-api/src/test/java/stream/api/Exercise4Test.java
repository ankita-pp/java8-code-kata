...
public class Exercise4Test extends ClassicOnlineStore {
    ...
    public void firstRegistrant() {
         ...
         */
        Optional<Customer> firstCustomer = this.mall.getCustomerList().stream().findFirst();
    ...
    public void isThereAnyoneOlderThan40() {
         ...
         */
        boolean olderThan40Exists = this.mall.getCustomerList().stream().anyMatch(customer -> customer.getAge() > 40);
    ...
    public void isEverybodyOlderThan20() {
         ...
         */
        boolean allOlderThan20 = this.mall.getCustomerList().stream().anyMatch(customer -> customer.getAge() > 20);
