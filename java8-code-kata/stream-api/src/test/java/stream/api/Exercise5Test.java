...
public class Exercise5Test extends ClassicOnlineStore {
    ...
    public void ageDistribution() {
         ...
         */
        Map<Integer, Long> ageDistribution = new HashMap<Integer, Long>();
        Consumer<Customer> consumer = customer -> ageDistribution.merge(customer.getAge(), 1L, Long::sum);
        customerList.stream().forEach(consumer);
